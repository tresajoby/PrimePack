        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-white/70 text-sm leading-relaxed mt-3">
              Quality Packaging. Reliable Supply.
            </p>
            <p className="text-white/60 text-sm leading-relaxed mt-4">
              Salaspils iela 6 K 4 ap.61
              <br />
              Riga LV-1057, Latvia
            </p>
            <div className="mt-4 space-y-2">
              <a
                href="tel:+37129429945"
              ...
              <a
                href="mailto:PrimePack.lv@gmail.com"
                className="flex items-center gap-2 text-white/70 hover:text-gold text-sm transition-colors"
              >
                <svg
                  className="w-4 h-4"
          ...
          <div>
            ...
            <div className="text-white/70 text-sm space-y-1">
              ...
              <p className="text-white/50">Closed</p>
            </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-white/50 text-sm">
            © {new Date().getFullYear()} PrimePack. All rights reserved.
          </p>
